...
export default function ACRepairPage() {
  ...
  const features = [
    { text: "24/7 emergency AC repair service" },
    { text: "Preventive maintenance programs" },
    { text: "Energy efficiency optimization" },
    { text: "All major AC brands covered" },
    { text: "Professional installation services" },
  ];

  const repairProcess = [
    { number: 1, title: "Diagnosis", description: "Comprehensive examination of your AC's hardware and cooling systems." },
    ...
    { number: 4, title: "Quality Check", description: "Thorough testing of cooling performance and all functions." },
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="animate-fade-in-up">
              ...
              <h1 className="text-4xl md:text-5xl font-bold font-headline text-primary">AC Repair Services</h1>
              <p className="mt-4 text-lg text-muted-foreground">
                Keep your space comfortable with our comprehensive AC repair services. We handle all types of air conditioners, from window units to central air systems, providing expert repairs, maintenance, and installation services.
              </p>
